        ...
        <div className="mx-auto flex h-14 max-w-[800px] items-center px-4 sm:px-6">
          ...
          <nav className="flex items-center gap-0.5 max-sm:hidden" aria-label="Primary navigation">
            {TAGS && (
              <a
                href={`${siteUrl}tags`}
                className={`rounded-[var(--radius-sm)] px-2.5 py-1.5 text-[13px] font-medium no-underline transition-colors duration-200 hover:bg-[var(--color-line)] ${isActive(tagsPathname) ? 'text-[var(--color-accent)]' : 'text-[var(--color-muted)] hover:text-[var(--color-heading)]'}`}>
                Tags
              </a>
            )}
            {LINKS && (
              <a
                href={`${siteUrl}links`}
                className={`rounded-[var(--radius-sm)] px-2.5 py-1.5 text-[13px] font-medium no-underline transition-colors duration-200 hover:bg-[var(--color-line)] ${isActive(linksPathname) ? 'text-[var(--color-accent)]' : 'text-[var(--color-muted)] hover:text-[var(--color-heading)]'}`}>
                Links
              </a>
            )}
            {navs.map((nav) => (
              <a
                ...
                className="rounded-[var(--radius-sm)] px-2.5 py-1.5 text-[13px] font-medium text-[var(--color-muted)] no-underline transition-colors duration-200 hover:bg-[var(--color-line)] hover:text-[var(--color-heading)]">
                {nav.title}
              </a>
            ))}
          </nav>
