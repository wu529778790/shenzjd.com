...
function getVideo($: CheerioAPI, message: MessageSelection, options: IndexedStaticProxyOptions): string {
  ...
  video.attr('controls', '').attr('preload', 'metadata').attr('playsinline', '').attr('webkit-playsinline', '')
  ...
  roundVideo.attr('controls', '').attr('preload', 'metadata').attr('playsinline', '').attr('webkit-playsinline', '')
